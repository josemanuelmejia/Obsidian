...
| File                                                                                                           | Event Start Date                                         | Event End Date | Author       | Title                                          | Publication                       | Date          | Page                                                                                                  |  
| -------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------- | -------------- | ------------ | ---------------------------------------------- | --------------------------------- | ------------- | ----------------------------------------------------------------------------------------------------- |  
| [annotated bibliography](../templates/annotated-bibliography.md)                                  | 2023-03-10 22:15                                         | \-             | \-           | \-                                             | \-                                | \-            | \-                                                                                                    |  
| [research note](../zotero/research-note.md)                                                       | {% if date %}{{date \| format("YYYY-MM-DD")}}{% endif %} | \-             | \-           | \-                                             | \-                                | \-            | {% for annotation in annotations %}{% if loop.first %}{{annotation.pageLabel}}{% endif %}{% endfor %} |  
| [remyherreraMarxistInterpretationCurrent2014](../../notes/remyherreramarxistinterpretationcurrent2014.md) | July 01, 2014                                            | \-             | Rémy Herrera | A Marxist Interpretation of the Current Crisis | World Review of Political Economy | July 01, 2014 | 128                                                                                                   |  
